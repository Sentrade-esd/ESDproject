...
const TradeHistory = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setCurrentBalance(
          LatestTransactionResponse.data.data.TotalAccountValue
        );
      } catch (error) {
  ...
  useEffect(() => {
    ...
    const openTrades = allTransactions
      .slice(1)
      .filter((transaction) => transaction.SellAmount === null);
    ...
    const closedTrades = allTransactions.filter(
      (transaction) => transaction.SellAmount !== null
    );
                            ...
                            <Col md="6">
                              <Card className="card-pricing">
                                <CardHeader className="bg-info">
                                  ...
                                  <CardTitle tag="h3">{item.Company}</CardTitle>
                                  <br></br>
                                </CardHeader>
                                <CardBody style={openTradesCard}>
                                  <ul>
                                    ...
                                    <li>
                                      ...
                                      {item.StopLossSentimentThreshold}
                                    </li>
                                    <li>
                                      <b style={{ color: "white" }}>
                                        Stocks Held:{" "}
                ...
                <Col md="10">
                  <Card className="card-coin card-plain">
                    <CardHeader>
                      ...
                      />
                      <h4 className="title" id="noMargin">
                        My Account
                      </h4>
                    </CardHeader>
                    <CardBody>
